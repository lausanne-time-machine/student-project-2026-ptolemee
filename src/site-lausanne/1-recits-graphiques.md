...
<h3>La Pontaise</h3>
<p>La Pontaise s’est développée et construite à partir de choix institutionnels : l’emplacement de la caserne pour la première Division Fédérale en novembre 1878<sup><a href="#fn1" id="ref1" class="footnote-link">[1]</a></sup>, au détriment de l’emplacement de la Cité, marque un tournant dans le rôle que jouera le quartier dans les décennies suivantes. L’Orphelinat (1873)<sup><a href="#fn2" id="ref2" class="footnote-link">[2]</a></sup> son stand de tir (agrandi en 1881)<sup><a href="#fn3" id="ref3" class="footnote-link">[3]</a></sup>, ses abattoirs (1887)<sup><a href="#fn4" id="ref4" class="footnote-link">[4]</a></sup>, l’établissement de la prison du Bois-Mermet (1904-5)<sup><a href="#fn5" id="ref5" class="footnote-link">[5]</a></sup> démontrent que la Pontaise s’est démarquée par des institutions rejetées par la ville.</p>
<p>Le climat du quartier, parfois conflictuel entre recrues militaires et habitants, tireurs et promeneurs, a été régulièrement polémique. Par l’entremise des Amis de la Pontaise, le quartier s’est régulièrement insurgé contre l’emplacement du stand de tir (bien que sécurisé en 1921<sup><a href="#fn6" id="ref6" class="footnote-link">[6]</a></sup>, elle en demandera le déplacement en 1934 encore)<sup><a href="#fn7" id="ref7" class="footnote-link">[7]</a></sup>, contre les décisions des colonels de la caserne (la querelle autour de la sortie de quartier en 1901 en est un exemple)<sup><a href="#fn8" id="ref8" class="footnote-link">[8]</a></sup>.</p><div class="obs-img-container">
...
<p>Le quartier voit ses rues nommées afin de mettre fin au “dédale” installé par l’aménagement chaotique progressif des rues<sup><a href="#fn15" id="ref15" class="footnote-link">[15]</a></sup>. Le café de la Violette, dit de tempérance, vient s’installer non loin de la caserne pour combattre les dérives de l’alcool<sup><a href="#fn16" id="ref16" class="footnote-link">[16]</a></sup>.</p>
<p>Le stand de tir pose également problème : un grave accident survient en 1912 où une manipulation dangereuse fait perdre la vie à un père de famille<sup><a href="#fn17" id="ref17" class="footnote-link">[17]</a></sup>. Bien que le stand fût sécurisé en 1921 (murs en béton, cibles électriques)<sup><a href="#fn6" id="ref6" class="footnote-link">[6]</a></sup>, son emplacement continuera à faire débat<sup><a href="#fn7" id="ref7" class="footnote-link">[7]</a></sup>.</p>
</div>
<div class="obs-clearfix">
<div class="obs-float-right">
...
<p>A Prélaz, les inondations du Flon et de la Mèbre sont fréquentes et mettent en péril les cultures ouvrières (1910 et 1917)<sup><a href="#fn18" id="ref18" class="footnote-link">[18]</a></sup> et on y déplore several accidents de la route entre des piétons, vélos et les multiples tramways sortant du dépôt.</p>
